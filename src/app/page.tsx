...
const REASONS = [
  {
    icon: "✦",
    title: "AIが4つの視点を統合する独自メソッド",
    body: "西洋占星術・インド占星術・四柱推命・心理学を、AIがひとつの人物像へ統合します。複数の視点が一致する「あなたの核」と、状況で出る「多面性」まで、ひとつの占術では見えないあなたを多角的に読み解きます。",
  },
  {
    icon: "🤖",
    title: "AIだから、毎回ブレない一貫性",
    body: "勘や霊感に頼らず、定義された手順で読み解きます。だからこそ、いつ受けても品質が安定し、4つの視点を公平に束ねられます。AIを活用していることを、私たちは隠しません。",
  },
  {
    icon: "🌙",
    title: "占い × 心理学で「行動」まで",
    body: "「当たる・外れる」で終わらせません。占いの結果を心理学の視点で翻訳し、今の自分とどう向き合い、明日どう動くかまで、やさしく言葉にします。",
  },
  {
    icon: "🔭",
    title: "誠実であること",
    body: "断定や不安をあおる表現はしません。読み解きの根拠もお示しします。占いはエンターテインメントとして、前向きな一歩につながる形でお届けします。",
  },
];
...
const STEPS = [
  ...
  },
  {
    no: "03",
    title: "リーディング",
    body: "AIがあなたの情報を、4つの視点（西洋・インド占星術・四柱推命・心理学）で統合し、ていねいに読み解きます。",
  },
  {
    no: "04",
    title: "結果のお届け",
...
const FAQS = [
  {
    q: "鑑定はAIが行うのですか？",
    a: "はい。Litwill Garden の鑑定は、AIが西洋占星術・インド占星術・四柱推命・心理学の4つの視点を統合して読み解きます。私たちはAIを活用していることを隠しません。勘や霊感に頼らないぶん、毎回ブレない一貫性と、断定や不安をあおらない誠実さを大切にしています。占いはエンターテインメントとしてお楽しみください。",
  },
  {
        ...
        <ConstellationField density="sparse">
          <div style={containerStyle}>
            <SectionHeader
              eyebrow="Readings"
              title="鑑定メニュー"
              sub="AIが西洋占星術・インド占星術・四柱推命・心理学の4つの視点を統合し、あなたの悩みに寄り添います。気になるテーマからご相談ください。"
            />
            <div
