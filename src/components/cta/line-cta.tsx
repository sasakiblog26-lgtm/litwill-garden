    ...
    <section className="celestial-panel rounded-xl p-6 md:p-8">
      <div className="text-center">
        ...
        <p className="text-text-muted mb-6">
          心理学のミニコラム、占いの更新、自己理解に役立つ問いをお届けします。
          <br className="hidden sm:block" />
          忙しい日にも、少しだけ自分の気持ちに戻れる時間を。
        </p>
        <a
          href={snsAccounts.line.url || "#"}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 rounded-lg bg-[#06C755] px-8 py-3 text-lg font-bold text-white transition-all hover:bg-[#05B34C] hover:shadow-[0_12px_30px_rgba(6,199,85,0.24)]"
        >
